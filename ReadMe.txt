...
The main objective of this project is to build a chat program. We have developed this program using two threads, which are main ones called as reading thread and writing thread. Using this application, we can send messages between connected users and also we can transfer files. 
...
2) Import project3_CN folder and open two terminals to start execution
3) All the files which needs to be uploaded to server needs to be kept in project3_CN like downloadTestFile.pptx
